...
export type IntelligenceFlagKey =
  ...
  // Additive profile/JD/reference multi-family EvidencePack coordinator.
  // Default OFF until explicitly rolled out.
...
const FLAGS: Record<IntelligenceFlagKey, FlagSpec> = {
  ...
  contextOsMultiFamilyEvidenceEnabled: { env: 'NATIVELY_CONTEXT_OS_MULTI_FAMILY_EVIDENCE', setting: 'contextOsMultiFamilyEvidenceEnabled', default: false },
